...
public class Hexa
{
	...
	public byte[] stringToByte(String str)
    {
        ...
        for (int i = 0; i < output.length; i++)
        {
            ...
            {
            	/* Notação ASCII
            	 * No índice 0, ch vale A, e A na ASCII é 65
            	 * 65 - 65 = 0, depois some de volta com A = 65, que na ASCII é A
            	 * Transforma em bits com o AND bit a bit no limite de 255 bits
            	 * em bits será 0100 0001, que é 41 em hexa, 65 em decimal e A em ASCII :)
            	 */            	 
            ...
            //Desloca 4 bits a esquerda, realiza um OR bit a bit e um AND bit a bit com o 255(0xFF)
	...
	//Método para quebrar a string Hexa (Não foi tulizado, porém ele ira separar de dois em dois caracteres a string
